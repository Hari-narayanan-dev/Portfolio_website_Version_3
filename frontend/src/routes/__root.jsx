...
export const Route = createRootRouteWithContext()({
    head: () => ({
        meta: [
            ...
            { name: "description", content: "Backend & AI engineer building scalable LLM-powered SaaS, fintech systems, and search-driven architectures. Bengaluru, India." },
            { name: "author", content: "Harinarayanan Pari" },
            { name: "theme-color", content: "#0a0a14" },
            { property: "og:title", content: "Harinarayanan Pari — Full-Stack & AI Systems Engineer" },
            { property: "og:description", content: "Scalable AI systems, LLM integration, fintech-grade backend architectures." },
